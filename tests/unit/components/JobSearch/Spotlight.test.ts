...
describe("Spotlight", () => {
  ...
  it("provides img attiribute to parent component", async () => {
  ...
  it("provides title attiribute to parent component", async () => {
  ...
  it("provides description attiribute to parent component", async () => {
